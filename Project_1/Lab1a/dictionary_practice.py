...
newDict = {'apple': 100, 'banana': 200, 'cantaloupe': 300
...
print(number_dict['cs251'] ) 

NewList = number_dict['cs251']
...
# YOUR CODE HERE
dict = { 'shoe_store': [], 'music_store':[]
    
}

for i in range(len(delivery)):
    if delivery[i] == 'shoes':
        dict['shoe_store'].append(delivery[i])
        print(dict['shoe_store'])
        print(dict['music_store'])
    else: 
        dict['music_store'].append(delivery[i])
        print(dict['shoe_store'])
        print(dict['music_store'])
